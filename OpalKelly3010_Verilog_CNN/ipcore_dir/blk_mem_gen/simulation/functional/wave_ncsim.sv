...
waveform  using  "Waves for BMG Example Design"
      ...
      waveform add -signals /blk_mem_gen_tb/blk_mem_gen_synth_inst/bmg_port/CLKB
      waveform add -signals /blk_mem_gen_tb/blk_mem_gen_synth_inst/bmg_port/ADDRB
      waveform add -signals /blk_mem_gen_tb/blk_mem_gen_synth_inst/bmg_port/DOUTB
