...
//*        Library Name     : tsdn65lplla65536x2m32s (user specify : TSDN65LPLLA65536X2M32S) */
//*        Library Version  : 200a */
//*        Generated Time   : 2020/04/17, 12:05:31 */
//*************************************************************************** ** */
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "TSDN65LPLLA65536X2M32S_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "TSDN65LPLLA65536X2M32S_fault.cde";
`endif
...
bwqh = 0.3173842;
  ...
  $setuphold (posedge CLKA &&& CSA, posedge AA[14], as, ah, valid_aa);
  $setuphold (posedge CLKA &&& CSA, negedge AA[14], as, ah, valid_aa);
  $setuphold (posedge CLKB &&& CSB, posedge AB[14], as, ah, valid_ab);
  $setuphold (posedge CLKB &&& CSB, negedge AB[14], as, ah, valid_ab);
  $setuphold (posedge CLKA &&& CSA, posedge AA[15], as, ah, valid_aa);
  $setuphold (posedge CLKA &&& CSA, negedge AA[15], as, ah, valid_aa);
  $setuphold (posedge CLKB &&& CSB, posedge AB[15], as, ah, valid_ab);
  $setuphold (posedge CLKB &&& CSB, negedge AB[15], as, ah, valid_ab);
...
TSDN65LPLLA65536X2M32S_Int_Array #(2,2,W,N,M,MES_ALL) MX (.D({DAL,DBL}),.BW({BWEBAL,BWEBBL}),
...
module TSDN65LPLLA65536X2M32S_Int_Array (D, BW, AW, EN, AAR, ABR, RDA, RDB, QA, QB);
